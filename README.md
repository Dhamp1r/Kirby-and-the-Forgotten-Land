I'm ashamed of the quality of the code, but this script does its job of unpacking and packing the "Filter.bin" file to add all the necessary font characters.
